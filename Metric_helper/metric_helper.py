...
metric_list = ["femto", "pico", 'nano', 'micro', 'milli', 'centi', "deci", "base value", "deca", "hecto", "kilo",
               "mega", "giga", "tera", "peta"]
...
convert_button.grid(row=2, column=0, columnspan=3, ipadx=50, padx=10, pady=10, command=convert)
